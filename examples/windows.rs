...
mod win {
        ...
        windows::{
            Win32::{
                ...
                UI::WindowsAndMessaging::{
                    ...
                    SW_SHOW, SWP_NOMOVE, SWP_NOZORDER, SetWindowLongPtrW, SetWindowPos,
                    SetWindowTextW, ShowWindow, TranslateMessage, WM_CREATE, WM_DESTROY, WM_QUIT,
    ...
    pub(super) fn handle_windows_message(r#loop: &Loop) {
...
fn main() {
    #[cfg(windows)]
    Loop::new()
        .register_poll_handler(win::handle_windows_message)
        .run(win::app)
}
